...
export const PatternSelectionContextProvider = ({ children }: PropsWithChildren) => {
	//
	...
	const [filterBySearchState, setFilterBySearchState] = useState<PatternSelectionContextState['filters']['by_search']>('');
