...
export function MoreSectionSupport() {
	...
	const LIST_ITEMS: ListSectionItemProps[] = [
		{
			icon: <IconHelpHexagon color={useSystemVariables().text[100]} size={32} />,
			key: 'faq',
			label: t('items.faq'),
			link: '/webview?url=https://www.carrismetropolitana.pt/faq',
		},
		{
			icon: <IconUmbrella color={useSystemVariables().text[100]} size={32} />,
			key: 'lost_and_found',
			label: t('items.lost_and_found'),
			link: '/webview?url=https://www.carrismetropolitana.pt/lost-and-found',
		},
		{
			icon: <IconBuildingStore color={useSystemVariables().text[100]} size={32} />,
			key: 'stores',
			label: t('items.stores'),
			link: '/webview?url=https://www.carrismetropolitana.pt/stores',
		},
		{
			icon: <IconMessages color={useSystemVariables().text[100]} size={32} />,
			key: 'contacts',
